...
--------------------------------------------------------
-- Sequences
CREATE SEQUENCE  PCMSDATAPROD.TENDER_VARIANCE_SEQ
START WITH 1
INCREMENT BY 1
...
CREATE TABLE PCMSDATAPROD.TENDER_VARIANCE(	
    ID                          NUMBER(19, 0),
...
ALTER TABLE PCMSDATAPROD.TENDER_VARIANCE MODIFY (ID_TENDER NOT NULL ENABLE);
ALTER TABLE PCMSDATAPROD.TENDER_VARIANCE MODIFY (NO_JOB NOT NULL ENABLE);
ALTER TABLE PCMSDATAPROD.TENDER_VARIANCE MODIFY (NO_SUBCONTRACT NOT NULL ENABLE);
ALTER TABLE PCMSDATAPROD.TENDER_VARIANCE MODIFY (NO_SUBCONTRACTOR NOT NULL ENABLE);
ALTER TABLE PCMSDATAPROD.TENDER_VARIANCE MODIFY (USERNAME_CREATED NOT NULL ENABLE);
ALTER TABLE PCMSDATAPROD.TENDER_VARIANCE MODIFY (DATE_CREATED NOT NULL ENABLE);
