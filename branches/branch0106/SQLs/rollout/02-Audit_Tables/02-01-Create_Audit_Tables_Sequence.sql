	...
	-------------------------------------------------------------------------
	create sequence PCMSDATAPROD.REVISION_SEQ
	  START WITH 1
	...
	create table PCMSDATAPROD.REVISION (
    ...
    create table PCMSDATAPROD.ADDENDUM_DETAIL_AUDIT (
    ...
    create table PCMSDATAPROD.JOB_INFO_AUDIT (
    ...
    create table PCMSDATAPROD.PAYMENT_CERT_AUDIT (
    ...
    create table PCMSDATAPROD.PAYMENT_CERT_DETAIL_AUDIT (
    ...
    create table PCMSDATAPROD.RESOURCE_SUMMARY_AUDIT (
    ...
    create table PCMSDATAPROD.SUBCONTRACT_AUDIT (
    ...
    create table PCMSDATAPROD.SUBCONTRACT_DETAIL_AUDIT (
    ...
    alter table PCMSDATAPROD.REVCHANGES 
        add constraint REVCHANGES_FK 
        foreign key (REV) 
        references PCMSDATAPROD.REVISION;

    alter table PCMSDATAPROD.ADDENDUM_AUDIT 
        add constraint ADDENDUM_AUDIT_FK
        foreign key (REV) 
        references PCMSDATAPROD.REVISION;

    alter table PCMSDATAPROD.ADDENDUM_DETAIL_AUDIT 
    ...
    alter table PCMSDATAPROD.PAYMENT_CERT_AUDIT 
        add constraint PAYMENT_CERT_AUDIT_FK
        foreign key (REV) 
        references PCMSDATAPROD.REVISION;

    alter table PCMSDATAPROD.PAYMENT_CERT_DETAIL_AUDIT 
        add constraint PAYMENTCERTDETAIL_AUDIT_FK
        foreign key (REV) 
        references PCMSDATAPROD.REVISION;

	alter table PCMSDATAPROD.RESOURCE_SUMMARY_AUDIT 
        add constraint RESOURCE_SUMMARY_AUDIT_FK 
        foreign key (REV) 
        references PCMSDATAPROD.REVISION;

    alter table PCMSDATAPROD.SUBCONTRACT_AUDIT 
        add constraint SUBCONTRACT_AUDIT_FK
        foreign key (REV) 
        references PCMSDATAPROD.REVISION;

    alter table PCMSDATAPROD.SUBCONTRACT_DETAIL_AUDIT 
