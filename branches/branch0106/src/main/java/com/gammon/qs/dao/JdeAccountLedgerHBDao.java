...
@Repository
public class JdeAccountLedgerHBDao extends BaseHibernateDao<JdeAccountLedger> {

	public JdeAccountLedgerHBDao() {
		super(JdeAccountLedger.class);
	}

	@SuppressWarnings("unchecked")
	public List<JdeAccountLedger> obtainAccountLedgersByJobNo(String jobNo, String ledgerType) throws DatabaseOperationException {
	...
	public JdeAccountLedger obtainAccountLedgerByAccountLedger(JdeAccountLedger accountLedger) throws DatabaseOperationException {
		Criteria criteria = null;
		criteria = getSession().createCriteria(this.getType());
		criteria.add(Restrictions.eq("systemStatus", BasePersistedAuditObject.ACTIVE ));
		...
		return (JdeAccountLedger) criteria.uniqueResult();
	}


	@SuppressWarnings("unchecked")
	public List<JdeAccountLedger> obtainAccountLedgersByBudgetForecastWrapper(BudgetForecastWrapper budgetForecastWrapper) throws DatabaseOperationException {
		List<JdeAccountLedger> accountLedgerList = new ArrayList<JdeAccountLedger>();
		...
		List<JdeAccountLedger> fc = criteria.list();
		if(fc!=null)
		...
		List<JdeAccountLedger> ob = criteria.list();
		if(ob!=null)
		...
		List<JdeAccountLedger> aa = criteria.list();
		if(aa!=null)
