...
public class AccountLedgerId implements Serializable {
	...
	public String toString() {
		return "AccountLedgerId [entityDocCompanyKey=" + entityDocCompanyKey + ", typeDocument=" + typeDocument + ", numberDocument=" + numberDocument + ", numberJournalEntryLine=" + numberJournalEntryLine + ", numberJeLineExtension=" + numberJeLineExtension + ", accountTypeLedger=" + accountTypeLedger + ", accountPeriod=" + accountPeriod + "]";
	}
