...
--------------------------------------------------------
CREATE SEQUENCE "PCMSDATADEV"."CLAIM_KPI_SEQ" MINVALUE 0 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 NOCACHE  NOORDER  NOCYCLE;
--------------------------------------------------------
--  Table CLAIM_KPI
--------------------------------------------------------
CREATE TABLE "PCMSDATADEV"."CLAIM_KPI"
(
    ...
    "EXCEPTION_COMMENT"      VARCHAR2(255 BYTE)
);
--------------------------------------------------------
--  Table CLAIM_KPI_AUDIT
--------------------------------------------------------
CREATE TABLE "PCMSDATADEV"."CLAIM_KPI_AUDIT"
(
...
--------------------------------------------------------
CREATE
UNIQUE INDEX "PCMSDATADEV"."CLAIM_KPI_UN" ON "PCMSDATADEV"."CLAIM_KPI" ("YEAR", "MONTH", "NO_JOB") ;
--------------------------------------------------------
--  Index CLAIM_KPI_PK
--------------------------------------------------------
  CREATE
UNIQUE INDEX "PCMSDATADEV"."CLAIM_KPI_PK" ON "PCMSDATADEV"."CLAIM_KPI" ("ID") ;
--------------------------------------------------------
--------------------------------------------------------
--  Constraints for Table CLAIM_KPI
--------------------------------------------------------
ALTER TABLE "PCMSDATADEV"."CLAIM_KPI"
...
--  Grant
--------------------------------------------------------
grant select on "PCMSDATADEV"."CLAIM_KPI_SEQ" to PCMSUSER_ROLE;
grant select, insert, update, delete on "PCMSDATADEV"."CLAIM_KPI" to "PCMSUSER_ROLE";
grant select, insert, update, delete on "PCMSDATADEV"."CLAIM_KPI_AUDIT" to "PCMSUSER_ROLE";

grant select on "PCMSDATADEV"."CLAIM_KPI" to IMS_SUPPORT_ROLE_QS;
grant select on "PCMSDATADEV"."CLAIM_KPI_AUDIT" to IMS_SUPPORT_ROLE_QS;
