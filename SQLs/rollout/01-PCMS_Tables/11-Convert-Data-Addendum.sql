...
select * from PCMSDATAPROD.addendum where no = '1' and date_created > '04-NOV-2016' and USERNAME_CREATED = 'SYSTEM';
...
--5.1 Generate Addendum for Addendum 1 (Addendum Approval In Progress)
-- delete from PCMSDATADEV.ADDENDUM where no = 1;
...
--5.2 Generate Addendum Detail for Addendum 1 (Addendum Approval In Progress)
...
--5.4 SC DETAILS Non-budget VO (in Progress)
update PCMSDATATST.Subcontract_Detail
set linetype = 'OA', approved = 'A', quantity = tobeapprovedqty
where system_status = 'ACTIVE' 
and subcontract_id in (select id from PCMSDATATST.subcontract where paymentstatus != 'F' and scstatus = '500' and submittedaddendum ='1' and job_info_id in (select id from PCMSDATATST.job_info where completionstatus = '1'))
...
--7. Update non-approved addendum's "Line Type" from V1, V2, L1, L2, D1, D2, CF to OA