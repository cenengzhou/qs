...
--------------------------------------------------------
-- Sequence
CREATE SEQUENCE PCMSDATAUAT.USER_PREFERENCE_SEQ
START WITH 1
INCREMENT BY 1
...
-- Table
CREATE TABLE PCMSDATAUAT.USER_PREFERENCE(	
    ID                          NUMBER(19, 0),
...
-- Constraints
ALTER TABLE PCMSDATAUAT.USER_PREFERENCE MODIFY (NO_STAFF NOT NULL ENABLE);
ALTER TABLE PCMSDATAUAT.USER_PREFERENCE MODIFY (USERNAME NOT NULL ENABLE);
ALTER TABLE PCMSDATAUAT.USER_PREFERENCE MODIFY (KEY_PREFERENCE NOT NULL ENABLE);
ALTER TABLE PCMSDATAUAT.USER_PREFERENCE MODIFY (VALUE_PREFERENCE NOT NULL ENABLE);
ALTER TABLE PCMSDATAUAT.USER_PREFERENCE MODIFY (USERNAME_CREATED NOT NULL ENABLE);
ALTER TABLE PCMSDATAUAT.USER_PREFERENCE MODIFY (DATE_CREATED NOT NULL ENABLE);
