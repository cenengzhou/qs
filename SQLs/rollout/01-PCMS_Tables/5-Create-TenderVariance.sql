...
--------------------------------------------------------
-- Sequences
CREATE SEQUENCE  "PCMSDATAUAT"."TENDER_VARIANCE_SEQ"
START WITH 1
INCREMENT BY 1
NOCYCLE
NOCACHE
...
--table
CREATE UNIQUE INDEX PCMSDATAUAT.TENDER_VARIANCE_PK ON PCMSDATAUAT.TENDER_VARIANCE (ID ASC);
CREATE TABLE "PCMSDATAUAT"."TENDER_VARIANCE"(	
    "ID"                          NUMBER(19, 0),
...
ALTER TABLE "PCMSDATAUAT"."TENDER_VARIANCE" MODIFY ("ID_TENDER" NOT NULL ENABLE);
ALTER TABLE "PCMSDATAUAT"."TENDER_VARIANCE" MODIFY ("NO_JOB" NOT NULL ENABLE);
ALTER TABLE "PCMSDATAUAT"."TENDER_VARIANCE" MODIFY ("NO_SUBCONTRACT" NOT NULL ENABLE);
ALTER TABLE "PCMSDATAUAT"."TENDER_VARIANCE" MODIFY ("NO_SUBCONTRACTOR" NOT NULL ENABLE);
ALTER TABLE "PCMSDATAUAT"."TENDER_VARIANCE" MODIFY ("USERNAME_CREATED" NOT NULL ENABLE);
ALTER TABLE "PCMSDATAUAT"."TENDER_VARIANCE" MODIFY ("DATE_CREATED" NOT NULL ENABLE);
