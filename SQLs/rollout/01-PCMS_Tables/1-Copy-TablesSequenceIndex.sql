--1. Copy from QSDATAUAT to PCMSDATATST

-- Total: 58 tables copy from QSDATAUAT to PCMSDATATST
...
-- Total: 38 sequences copy from QSDATAUAT to PCMSDATATST
...
-- Total: 63 indexes copy from QSDATAUAT to PCMSDATATST
