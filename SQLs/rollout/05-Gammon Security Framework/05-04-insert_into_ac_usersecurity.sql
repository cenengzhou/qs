...
from 
	...
	from 
	QSADMINUAT.QS_APP_USER u left join QSADMINUAT.QS_LINK_USER_AUTHORITY lua on u.id = lua.user_id 
	left join QSADMINUAT.QS_APP_AUTHORITY ua on lua.AUTHORITY_ID = ua.id
	where 
	...
	left join (
		...
		SELECT 'ROLE_QS_IMS_ADM' as QS_ROLE , 'ROLE_PCMS_QS_ENQ' as PCMS_ROLE FROM DUAL UNION
		...
		SELECT 'ROLE_QS_ADMIN' as QS_ROLE , 'ROLE_PCMS_IMS_ENQ' as PCMS_ROLE FROM DUAL UNION
		...
		SELECT 'JOB_CHN' as QS_ROLE , 'JOB_CHN' as PCMS_ROLE FROM DUAL UNION
