	...
	End;
	grant EXECUTE on "PCMSDATADEV"."AUDIT_HOUSEKEEP" to "QSUSER3_ROLE";
	...
	BEGIN
	  ...
	  RETURN l_date;
	END;
	grant EXECUTE on "PCMSDATADEV"."UNIX_TS_TO_DATE" to "QSUSER3_ROLE" ;
	...
	GRANT SELECT ON "PCMSDATADEV"."REVISION_SEQ" TO "QSUSER3_ROLE";
	...
	TABLESPACE "QSDATADEVT" ;
	GRANT DELETE, INSERT, SELECT, UPDATE ON "PCMSDATADEV"."ADDENDUM_AUDIT" TO "QSUSER3_ROLE";
	...
	TABLESPACE "QSDATADEVT" ;
	GRANT DELETE, INSERT, SELECT, UPDATE ON "PCMSDATADEV"."ADDENDUM_DETAIL_AUDIT" TO "QSUSER3_ROLE";
	...
	TABLESPACE "QSDATADEVT" ;
	GRANT DELETE, INSERT, SELECT, UPDATE ON "PCMSDATADEV"."JOB_INFO_AUDIT" TO "QSUSER3_ROLE";
	...
	TABLESPACE "QSDATADEVT" ;
	GRANT DELETE, INSERT, SELECT, UPDATE ON "PCMSDATADEV"."PAYMENT_CERT_AUDIT" TO "QSUSER3_ROLE";
	...
	TABLESPACE "QSDATADEVT" ;
	GRANT DELETE, INSERT, SELECT, UPDATE ON "PCMSDATADEV"."PAYMENT_CERT_DETAIL_AUDIT" TO "QSUSER3_ROLE";
	...
	TABLESPACE "QSDATADEVT" ;
	GRANT DELETE, INSERT, SELECT, UPDATE ON "PCMSDATADEV"."RESOURCE_SUMMARY_AUDIT" TO "QSUSER3_ROLE";
	...
	TABLESPACE "QSDATADEVT" ;
	GRANT DELETE, INSERT, SELECT, UPDATE ON "PCMSDATADEV"."SUBCONTRACT_AUDIT" TO "QSUSER3_ROLE";
