...
<html lang="en">
  ...
  v = {
    ...
    rmkCpf: { h: 'CPF Base Period: 17 CPF Base Year: 2019', f: '[#if subcontract.cpfCalculation?? && (subcontract.cpfCalculation == "1" || subcontract.cpfCalculation == "Subject to CPF")]CPF Base Period: ${subcontract.cpfBasePeriod!0} CPF Base Year: ${subcontract.cpfBaseYear!0}[#else]No CPF[/#if]' },
