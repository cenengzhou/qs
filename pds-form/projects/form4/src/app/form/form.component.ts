...
<html lang="en">
  ...
  v = {
    ...
    rcmAmount: { h: 'HK$100.00', f: '${companyCurrencyCode!""} ${((rcmTenderer.budgetAmount!0)-(rcmTenderer.amtBuyingGainLoss!0)) ?string["#,##0.00"]}\n\t\t\t\t\t\t\t\t\t\t\t[#if companyCurrencyCode != rcmTenderer.currencyCode]<label>(${rcmTenderer.currencyCode!""} ${(((rcmTenderer.budgetAmount!0)-(rcmTenderer.amtBuyingGainLoss!0))/(rcmTenderer.exchangeRate!0)) ?string["#,##0.00"]})</label>\n\t\t\t\t\t\t\t\t\t\t\t[/#if]' },
    rcmBudget: { h: 'HK$90.00', f: '${companyCurrencyCode!""} ${(budgetTender.budgetAmount!0)?string["#,##0.00"]}' },
    rcmBuyLoss: { h: 'HK$10.00', f: '${companyCurrencyCode!""} ${(rcmTenderer.amtBuyingGainLoss!0)?string["#,##0.00"]}' },
    ...
    rcmTargetAmount: { h: '0', f: '${companyCurrencyCode!""} ${subcontract.amountPackageStretchTarget!0}' },
