...
const Sidebar = () => {
    ...
    let treeData: { [key: string]: Object }[] = [
        { id: "1", name: "Session", iconCss: "e-icons e-small e-copy", selected: true },
        { id: "2", name: "Manual Procedures" },
        { id: "3", name: "Revisions" },
        { id: "5", name: "Transit", hasChild: true, expanded: false },
        { id: "6", name: "Subcontract", hasChild: true, expanded: false },
        { id: "7", name: "Scheduler Maintenance" },
        { id: "8", name: "Announcement Setting" },
        { id: "9", name: "System Information" },
        { id: "10", name: "System Information" },
        { id: "51", name: "UOM Maintenance", pid: "5" },
        { id: "52", name: "Resource Code Maintenance", pid: "5" },
        { id: "61", name: "Standard Terms Maintenance", pid: "6" }
    ];
    const [data, setData] = useState<{[key: string]: Object}[]>(inboxData);

    let treeFields: { [key: string]: Object } = { dataSource: treeData, id: "id", text: "name", selected: "selected", parentID: "pid", hasChildren: "hasChild", expanded: "expanded", iconCss: "iconCss" };
    ...
    return (
        <div className="control-section" id="sidebar-wrapper">
            ...
            <SidebarComponent id="defaultSidebar" ref={sidebarobj} className="default-sidebar" width="250px" target=".maincontent" position="Left">
