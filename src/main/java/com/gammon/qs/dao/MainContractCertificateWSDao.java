...
@Repository
public class MainContractCertificateWSDao {

	private Logger logger = Logger.getLogger(MainContractCertificateWSDao.class.getName());
	@Autowired
	 ...
	 */
	public PaginationWrapper<MainContractCertificate> getMainContractCertificateByPage(String jobNumber, int pageNum) throws UnsupportedOperationException {
