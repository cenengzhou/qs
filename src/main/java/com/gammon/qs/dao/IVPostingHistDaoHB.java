...
@Repository
public class IVPostingHistDaoHB extends BaseHibernateDao<IVPostingHist> {

	public IVPostingHistDaoHB() {
		super(IVPostingHist.class);
	}
	
	@SuppressWarnings("unchecked")
	public List<IVPostingHist> obtainIVPostingHistory(String jobNumber, String packageNo, String objectCode, String subsidiaryCode, Date fromDate, Date toDate) throws Exception{
