...
@Repository
public class TransitBQHBDao extends BaseHibernateDao<TransitBQ> {
	public TransitBQHBDao() {
		super(TransitBQ.class);
	}

	private Logger logger = Logger.getLogger(TransitBQHBDao.class.getName());
	...
	public List<TransitBQ> getTransitBqByHeaderNoCommentLines(TransitHeader header){
		...
		return (List<TransitBQ>)criteria.list();
	}
