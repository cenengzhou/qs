...
@Entity
@Table(name = "QS_ACCOUNT_LEDGER")
@OptimisticLocking(type = OptimisticLockType.NONE)
@SequenceGenerator(name = "qs_account_ledger_gen",  sequenceName = "qs_account_ledger_seq", allocationSize = 1)
...
public class AccountLedger extends BasePersistedObject {
	...
	public String toString() {
		return "AccountLedger [jobNo=" + jobNo + ", objectCode=" + objectCode + ", description=" + description
	...
	@Override
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "qs_account_ledger_gen")
