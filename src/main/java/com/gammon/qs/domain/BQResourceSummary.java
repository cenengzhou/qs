...
@Entity
@Table(name = "QS_BQRESOURCE_SUMMARY")
@OptimisticLocking(type = OptimisticLockType.NONE)
@SequenceGenerator(name = "qs_bqresource_summary_gen",  sequenceName = "qs_bqresource_summary_seq", allocationSize = 1)
@AttributeOverride(name = "id", column = @Column(name = "ID", unique = true, nullable = false, insertable = false, updatable = false, precision = 19, scale = 0))
public class BQResourceSummary extends BasePersistedObject implements Comparable<BQResourceSummary>{
	...
	private BQResourceSummary splitFrom;
	private BQResourceSummary mergeTo;
	...
	public int compareTo(BQResourceSummary o) {
		if(equals(o))
			return 0;
		if(objectCode == null){
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BQResourceSummary other = (BQResourceSummary) obj;
		if (objectCode == null) {
	...
	public String toString() {
		return "BQResourceSummary [job=" + job + ", packageNo=" + packageNo + ", subsidiaryCode=" + subsidiaryCode
	...
	@Override
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "qs_bqresource_summary_gen")
	...
	@JoinColumn(name = "JOB_ID", nullable = true, foreignKey = @ForeignKey(name = "FK_BQResourSumJOB_PK"))
	public Job getJob() {
		return job;
	}
	...
	public BQResourceSummary getSplitFrom() {
		return splitFrom;
	}
	public void setSplitFrom(BQResourceSummary splitFrom) {
	...
	public BQResourceSummary getMergeTo() {
		return mergeTo;
	}
	public void setMergeTo(BQResourceSummary mergeTo) {
