...
public class SCDetailsOA extends SCDetails {
	...
	public void updateSCDetails(SCDetailsOA scDetails){
	...
	public String toString() {
		return "SCDetailsOA [postedWorkDoneQuantity=" + postedWorkDoneQuantity + ", cumWorkDoneQuantity="
