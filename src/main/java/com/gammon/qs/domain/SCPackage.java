...
@Entity
@Table(name = "QS_SC_PACKAGE")
@OptimisticLocking(type = OptimisticLockType.NONE)
@SequenceGenerator(name = "qs_sc_package_gen",  sequenceName = "qs_sc_package_seq", allocationSize = 1)
@AttributeOverride(name = "id", column = @Column(name = "ID", unique = true, nullable = false, insertable = false, updatable = false, precision = 19, scale = 0))
public class SCPackage extends BasePersistedObject{
	...
	public static String convertSplitTerminateStatus(String splitTerminateStatus) {
		if(splitTerminateStatus!=null && !"".equals(splitTerminateStatus)){
			...
			return SCPackage.SPLITTERMINATESTATUSES[status][1];
		}
		return "";
	}
	...
	public String toString() {
		return "SCPackage [jobId=" + job.getId() + ", packageNo=" + packageNo + ", description=" + description + ", packageType="
	...
	@JoinColumn(name = "job_ID", foreignKey = @ForeignKey(name = "FK_scPackage_Job_PK"))
	public Job getJob() {
		return job;
	}
