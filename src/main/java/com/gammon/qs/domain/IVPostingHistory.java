...
@Entity
@Table(name = "QS_IVPOSTING_HISTORY")
@OptimisticLocking(type = OptimisticLockType.NONE)
@SequenceGenerator(name = "qs_ivposting_history_gen",  sequenceName = "qs_ivposting_history_seq", allocationSize = 1)
@AttributeOverride(name = "id", column = @Column(name = "ID", unique = true, nullable = false, insertable = false, updatable = false, precision = 19, scale = 0))
public class IVPostingHistory extends BasePersistedObject {
	...
	public String toString() {
		return "IVPostingHistory [resourceSummaryId=" + resourceSummaryId + ", jobNumber=" + jobNumber + ", packageNo="
	...
	@Override
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "qs_ivposting_history_gen")
