...
@Entity
@Table(name = "QS_SCPAYMENT_CERT")
@OptimisticLocking(type = OptimisticLockType.NONE)
@SequenceGenerator(name = "qs_sc_payment_cert_gen", sequenceName = "qs_sc_payment_cert_seq", allocationSize = 1)
@AttributeOverride(name = "id", column = @Column(name = "ID", unique = true, nullable = false, insertable = false, updatable = false, precision = 19, scale = 0))
public class SCPaymentCert extends BasePersistedObject {
	...
	public SCPaymentCert() {
		super();
	}
	
	public boolean equals(Object object){
		if (object !=null && object instanceof SCPaymentCert){
			SCPaymentCert refObj = (SCPaymentCert)object;
			if (this.scPackage.equals(refObj.getScPackage())){
	...
	public String toString() {
		return "SCPaymentCert [scPackage=" + scPackage 
	...
	@Override
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "qs_sc_payment_cert_gen")
	...
	@JoinColumn(name = "scPackage_ID", insertable = true, updatable = true)
