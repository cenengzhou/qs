...
@Entity
@Table(name = "QS_RESOURCE")
@BatchSize(size = 20)
@OptimisticLocking(type = OptimisticLockType.NONE)
@SequenceGenerator(name = "qs_resource_gen",  sequenceName = "qs_resource_seq", allocationSize = 1)
@AttributeOverride(name = "id", column = @Column(name = "ID", unique = true, nullable = false, insertable = false, updatable = false, precision = 19, scale = 0))
public class Resource extends BasePersistedObject {
	...
	@Override
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "qs_resource_gen")
...
//	@Cascade(CascadeType.SAVE_UPDATE)
	@JoinColumn(name = "bqItem_ID", foreignKey = @ForeignKey(name = "FK_ResourceBQItem_PK"), insertable = true, updatable = true)
