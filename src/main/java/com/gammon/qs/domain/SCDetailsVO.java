...
public class SCDetailsVO extends SCDetailsBQ {
	...
	public void updateSCDetails(SCDetailsVO scDetails){
	...
	public String toString() {
		return "SCDetailsVO [toBeApprovedRate=" + toBeApprovedRate + ", contraChargeSCNo=" + contraChargeSCNo
