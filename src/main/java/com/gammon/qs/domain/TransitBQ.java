...
@Entity
@Table(name = "QS_TransitBQ")
@OptimisticLocking(type = OptimisticLockType.NONE)
@SequenceGenerator(name = "qs_transitBQ_gen", sequenceName = "qs_transitBQ_seq", allocationSize = 1)
@AttributeOverride(name = "id", column = @Column(name = "ID", unique = true, nullable = false, insertable = false, updatable = false, precision = 19, scale = 0))
public class TransitBQ extends BasePersistedObject{

	private static final long serialVersionUID = 8523130356526001971L;
	
	private TransitHeader transitHeader;
	...
	public String toString() {
		return "TransitBQ [transitHeader=" + transitHeader + ", sequenceNo="
	...
	@Override
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "qs_transitBQ_gen")
	...
	@JoinColumn(name = "transitHeader_ID", foreignKey = @ForeignKey(name = "FK_TransitBQTransitHeader_PK"))
	public TransitHeader getTransitHeader() {
		return transitHeader;
	}
	public void setTransitHeader(TransitHeader transitHeader) {
