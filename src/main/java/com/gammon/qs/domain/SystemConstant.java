...
@Entity
@Table(name = "QS_SystemConstant")
@OptimisticLocking(type = OptimisticLockType.NONE)
@IdClass(SystemConstantId.class)
public class SystemConstant extends BasePersistedAuditObject {
	...
	public void update(SystemConstant systemConstant) {
	...
	public String toString() {
		return "SystemConstant [systemCode=" + systemCode + ", company=" + company + ", scPaymentTerm=" + scPaymentTerm
