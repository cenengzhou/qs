...
@Entity
@Table(name = "QS_TransitHeader")
@OptimisticLocking(type = OptimisticLockType.NONE)
@SequenceGenerator(name = "qs_transitHeader_gen", sequenceName = "qs_transitHeader_seq", allocationSize = 1)
@AttributeOverride(name = "id", column = @Column(name = "ID", unique = true, nullable = false, insertable = false, updatable = false, precision = 19, scale = 0))
public class TransitHeader extends BasePersistedObject{
	...
	public String toString() {
		return "TransitHeader [jobNumber=" + jobNumber + ", estimateNo=" + estimateNo
	...
	@Override
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "qs_transitHeader_gen")
