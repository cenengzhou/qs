...
public class SCDetailsCC extends SCDetails {
	 ...
	 * @param scDetails
	 */
	public void updateSCDetails(SCDetailsCC scDetails){
	...
	public String toString() {
		return "SCDetailsCC [contraChargeSCNo=" + contraChargeSCNo + ", altObjectCode=" + altObjectCode
