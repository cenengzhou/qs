...
public class JobInfo extends BasePersistedObject implements Comparable<JobInfo> {
	...
	private Double residualAfterEot = 0.0;
	...
	private String natureOfWorkBB;
	private String natureOfWorkGammon;
	...
	private String engineerArchitect;
	private String beam;
	...
	@Column(name = "RESIDUAL_AFTER_EOT")
	public Double getResidualAfterEot() {
		return residualAfterEot != null ? residualAfterEot : 0.0;
	}

	public void setResidualAfterEot(Double residualAfterEot) {
		this.residualAfterEot = residualAfterEot;
	}
	...
	@Column(name = "NATURE_OF_WORK_BB")
	public String getNatureOfWorkBB() {
		return natureOfWorkBB;
	}
	public void setNatureOfWorkBB(String natureOfWorkBB) {
		this.natureOfWorkBB = natureOfWorkBB;
	}
	
	@Column(name = "NATURE_OF_WORK_GAMMON")
	public String getNatureOfWorkGammon() {
		return natureOfWorkGammon;
	}
	public void setNatureOfWorkGammon(String natureOfWorkGammon) {
		this.natureOfWorkGammon = natureOfWorkGammon;
	}
	
	@Column(name = "NO_TENDER")
	...
	@Column(name = "PARENT_JOB_NO_IMME")
	public String getImmediateParentJobNumber() {
		return immediateParentJobNumber;
	}
	public void setImmediateParentJobNumber(String immediateParentJobNumber) {
		this.immediateParentJobNumber = immediateParentJobNumber;
	}
	
	@Column(name = "PARENT_JOB_NO_ULT")
	public String getUltimateParentJobNumber() {
		return ultimateParentJobNumber;
	}
	public void setUltimateParentJobNumber(String ultimateParentJobNumber) {
...
//	}
	...
	public void setUltimateClient(String ultimateClient) {
		this.ultimateClient = ultimateClient;
	}
	
	@Column(name = "CLIENT_BUSINESS_SECTOR_IMME")
	public String getImmediateClientBusinessSector() {
		return immediateClientBusinessSector;
	}
	public void setImmediateClientBusinessSector(String immediateClientBusinessSector) {
		this.immediateClientBusinessSector = immediateClientBusinessSector;
	}
	

	@Column(name = "CLIENT_BUSINESS_SECTOR_ULT")
	public String getUltimateClientBusinessSector() {
		return ultimateClientBusinessSector;
	}
	public void setUltimateClientBusinessSector(String ultimateClientBusinessSector) {
		this.ultimateClientBusinessSector = ultimateClientBusinessSector;
	}
	...
	@Column(name = "ENGINEER_ARCHITECT")
	public String getEngineerArchitect() {
		return engineerArchitect;
	}
	public void setEngineerArchitect(String engineerArchitect) {
		this.engineerArchitect = engineerArchitect;
	}
	...
	@Column(name = "BEAM_PLUS")
	public String getBeamPlus() {
		return beamPlus;
	}
	public void setBeamPlus(String beamPlus) {
		this.beamPlus = beamPlus;
	}
	
	@Column(name = "LEED")
	public String getLeed() {
		return leed;
	}
