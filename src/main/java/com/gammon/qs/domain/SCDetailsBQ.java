...
public class SCDetailsBQ extends SCDetailsOA {
	...
	public void updateSCDetails(SCDetailsBQ scDetails) {
	...
	public String toString() {
		return "SCDetailsBQ [costRate=" + costRate + ", toBeApprovedQuantity=" + toBeApprovedQuantity + ", toString()="
				+ super.toString() + "]";
	}
