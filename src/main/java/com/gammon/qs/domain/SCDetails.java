...
@Entity
@Table(name = "QS_SC_DETAILS")
@OptimisticLocking(type = OptimisticLockType.NONE)
@Inheritance(strategy = InheritanceType.SINGLE_TABLE)
@DiscriminatorColumn(name = "TYPE", discriminatorType = DiscriminatorType.STRING, length = 2)
@SequenceGenerator(name = "qs_sc_details_gen",  sequenceName = "qs_sc_details_seq", allocationSize = 1)
@AttributeOverride(name = "id", column = @Column(name = "ID", unique = true, nullable = false, insertable = false, updatable = false, precision = 19, scale = 0))
public class SCDetails extends BasePersistedObject {
	...
	public void updateSCDetails(SCDetails scDetails){
	...
	public String toString() {
		return "SCDetails [jobNo=" + jobNo + ", sequenceNo=" + sequenceNo + ", resourceNo=" + resourceNo + ", billItem="
				...
				+ tenderAnalysisDetail_ID + ", scPackage=" + scPackage + ", balanceType=" + balanceType
				+ ", toString()=" + super.toString() + "]";
	}

	@Override
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "qs_sc_details_gen")
	...
	@JoinColumn(name = "scPackage_ID", foreignKey = @ForeignKey(name = "FK_SCDetailSCPackage_PK"), updatable = true, insertable = true)
