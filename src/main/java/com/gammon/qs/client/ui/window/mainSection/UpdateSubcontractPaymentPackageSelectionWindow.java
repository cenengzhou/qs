 ...
 */
public class UpdateSubcontractPaymentPackageSelectionWindow extends Window {
	...
	public UpdateSubcontractPaymentPackageSelectionWindow(GlobalSectionController globalSectionController) {
		super();
		this.globalSectionController = globalSectionController;
		setupUI();
	}
		...
		globalSectionController.getPackageRepository().getSCPackages(globalSectionController.getJob(), new AsyncCallback<List<SCPackage>>() {
			public void onSuccess(List<SCPackage> scPackages) {
				if(checkPackageExist(scPackages,packageNumber)){
					...
					globalSectionController.closeCurrentWindow();
					globalSectionController.setCurrentWindow(null);
					globalSectionController.getTreeSectionController().getPaymentTreePanel().showPaymentCertificateMainPanel(packageNumber);
					globalSectionController.getTreeSectionController().getGlobalSectionController().setSelectedPackageNumber(packageNumber);
				}else{
