...
public class MailContentGenerator {
	...
	public String obtainEmailContentForScheduleJob(Date startTime, Date endTime, String exceptionMaessage) {
		String emailHeader = "<html><head><meta content=\"text/html; charset=ISO-8859-1\" http-equiv=\"content-type\">"
				+ "<title>Exceptional Report</title>" + "<style type=\"text/css\">" + "body {" + "font-family: Arial;"
				+ "font-size: 8pt:8pt" + ";" + "}" + "table.simple {" + "border: 0px solid black;" + "padding: 5px;"
				+ "font-family: arial;" + "font-size: 8pt:8pt" + ";" + "}" + "tr.first {" + "background-color: #ffffff;"
				+ "height: 25px;" + "}" + "tr.second {" + "background-color: #ccffcc;" + "height: 25px;" + "}" + "td.cell02 {"
				+ "border-bottom: 1px solid black;" + "}" + "</style>" + "</head>" + "<body>";

		String mainContent = "Dear All ,<br><br>" + "System: QS System <br>" + "Server: " + environmentConfig.getNodeName()
				+ "<br>";
		if (startTime == null)
	...
	public boolean sendAdminFnEmail(String subject, String content) {
		Object principal = SecurityContextHolder.getContext().getAuthentication().getPrincipal();
		String username = principal instanceof UserDetails ? ((UserDetails)principal).getUsername() : principal.toString();
		return sendEmail(subject + " by " + username, content);
	}
