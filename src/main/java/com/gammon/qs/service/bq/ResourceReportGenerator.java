...
public class ResourceReportGenerator {
	...
	public ResourceReportGenerator(List<Resource> resourceList, String jobNumber){
	...
	private void generateResource() throws Exception {
		...
		for(Resource resource: resourceList){
			...
			excelFile.getDocument().setCellValue(row, index++, resource.getBqItem().getPage().getBill().getBillNo()!=null?resource.getBqItem().getPage().getBill().getBillNo():"", true);
			excelFile.getDocument().setCellValue(row, index++, resource.getBqItem().getPage().getBill().getSubBillNo()!=null ?resource.getBqItem().getPage().getBill().getSubBillNo():"", true);
			excelFile.getDocument().setCellValue(row, index++, resource.getBqItem().getPage().getPageNo()!=null?resource.getBqItem().getPage().getPageNo():"",true);
			excelFile.getDocument().setCellValue(row, index++, resource.getBqItem().getItemNo()!=null?resource.getBqItem().getItemNo():"",true);
