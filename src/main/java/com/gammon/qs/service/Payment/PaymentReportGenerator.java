...
public class PaymentReportGenerator {
	...
	private List<PaymentCertDetail> scPaymentDetailList;
	private String jobNumber;
	private String packageNo;
	private String paymentCertNo;
	
	public PaymentReportGenerator(List<PaymentCertDetail> scPaymentDetailList, String jobNumber, String packageNo,String paymentCertNo)
	{
	...
	private String[] createContentRow(PaymentCertDetail scPaymentDetail, int sheetSize)
	{
