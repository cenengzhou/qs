...
public class RetentionReleaseScheduleEnquiryWindowsWrapper implements Serializable{
	...
	public RetentionReleaseScheduleEnquiryWindowsWrapper() {
		super();
	}
	public RetentionReleaseScheduleEnquiryWindowsWrapper(String division,
			String jobNo, String jobDesc, Double estimatedRetention,
			Date completionDate, Integer dlp, Double cumRetentionRec,
			Integer retentionReleaseSeq, Double receiptAmt, Date receiptDate,
			Integer mainCert, Double outstandingAmt, Date dueDate, String company) {
		super();
