...
/**
 * AccountLedger generated by hbm2java
 */
@Entity
@IdClass(AccountLedgerId.class)
...
public class AccountLedger implements java.io.Serializable {
	...
	public AccountLedger(	String entityDocCompanyKey,
							...
							String accountTypeLedger,
							BigDecimal accountPeriod,
							String typeDocumentDescription,
							Date dateGl,
							String statusPost,
							String statusPostDescription,
							BigDecimal numberBatch,
							String typeBatch,
							String typeBatchDescription,
							Date dateBatch,
							Date dateInput,
							...
							String accountTypeLedgerDescr,
							BigDecimal accountFiscalYear,
							String currencyCode,
							BigDecimal amount,
							BigDecimal itemKey,
							BigDecimal quantity,
							String quantityUnitOfMeasurement,
							String accountGlClass,
							String typeReverseOrVoid,
							String explanationAddressBook,
							String explanationRemark,
							String reference1,
							String reference2,
							String reference3,
							String numberPayItem,
							BigDecimal entityAddressBookKey,
							String recordKeyVoucher,
							String recordKeyMatchedPo,
							String numberPaymentOrCheck,
							Date datePaymentOrCheck,
							String typeReconciliation,
							String numberAssetIdentification,
							String statusFixedAssetPosted,
							String numberInvoice,
							Date dateInvoice,
							String entityInputBy,
							BigDecimal recordKeyPaymentId,
							String entityGlPostedBy,
							Date datePosted,
							String taxRateCode,
							String taxExplCode,
							String taxExplanationDescription) {
		super();
		this.entityDocCompanyKey = entityDocCompanyKey;
		this.typeDocument = typeDocument;
		this.numberDocument = numberDocument;
	...
	@Column(name = "STATUS_POST_DESCRIPTION",
			length = 9)
	...
	@Column(name = "TYPE_BATCH_DESCRIPTION",
			length = 244)
	...
	@Column(name = "ACCOUNT_TYPE_LEDGER_DESCR",
			length = 120)
	...
	@Column(name = "ACCOUNT_FISCAL_YEAR",
			precision = 22,
			scale = 0)
	...
	@Column(name = "QUANTITY_UNIT_OF_MEASUREMENT",
			length = 8)
	...
	@Column(name = "TYPE_REVERSE_OR_VOID",
			length = 7)
	...
	@Column(name = "EXPLANATION_ADDRESS_BOOK",
			length = 120)
	...
	@Column(name = "EXPLANATION_REMARK",
			length = 120)
	...
	@Column(name = "ENTITY_ADDRESS_BOOK_KEY",
			precision = 22,
			scale = 0)
	...
	@Column(name = "RECORD_KEY_VOUCHER",
			length = 84)
	...
	@Column(name = "RECORD_KEY_MATCHED_PO",
			length = 112)
	...
	@Column(name = "NUMBER_PAYMENT_OR_CHECK",
			length = 32)
	...
	@Column(name = "DATE_PAYMENT_OR_CHECK",
			length = 7)
	...
	@Column(name = "NUMBER_ASSET_IDENTIFICATION",
			length = 100)
	...
	@Column(name = "STATUS_FIXED_ASSET_POSTED",
			length = 4)
	...
	@Column(name = "RECORD_KEY_PAYMENT_ID",
			precision = 22,
			scale = 0)
	...
	@Column(name = "ENTITY_GL_POSTED_BY",
			length = 40)
	...
	@Column(name = "TAX_EXPLANATION_DESCRIPTION",
			length = 120)
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof AccountLedger)) {
			return false;
		}
		AccountLedger other = (AccountLedger) obj;
	...
	public String toString() {
		return "AccountLedger [entityDocCompanyKey=" + entityDocCompanyKey + ", typeDocument=" + typeDocument + ", typeDocumentDescription=" + typeDocumentDescription + ", numberDocument=" + numberDocument + ", dateGl=" + dateGl + ", numberJournalEntryLine=" + numberJournalEntryLine + ", numberJeLineExtension=" + numberJeLineExtension + ", statusPost=" + statusPost + ", statusPostDescription=" + statusPostDescription + ", numberBatch=" + numberBatch + ", typeBatch=" + typeBatch + ", typeBatchDescription=" + typeBatchDescription + ", dateBatch=" + dateBatch + ", dateInput=" + dateInput + ", entityCompanyKey=" + entityCompanyKey + ", accountGl=" + accountGl + ", accountKey=" + accountKey + ", entityBusinessUnitKey=" + entityBusinessUnitKey + ", accountObject=" + accountObject + ", accountSubsidiary=" + accountSubsidiary + ", accountSubLedger=" + accountSubLedger + ", accountTypeSubLedger=" + accountTypeSubLedger + ", accountTypeLedger=" + accountTypeLedger + ", accountTypeLedgerDescr=" + accountTypeLedgerDescr + ", accountPeriod=" + accountPeriod + ", accountFiscalYear=" + accountFiscalYear + ", currencyCode=" + currencyCode + ", amount=" + amount + ", itemKey=" + itemKey + ", quantity=" + quantity + ", quantityUnitOfMeasurement=" + quantityUnitOfMeasurement + ", accountGlClass=" + accountGlClass + ", typeReverseOrVoid=" + typeReverseOrVoid + ", explanationAddressBook=" + explanationAddressBook + ", explanationRemark=" + explanationRemark + ", reference1=" + reference1 + ", reference2=" + reference2 + ", reference3=" + reference3 + ", numberPayItem=" + numberPayItem + ", entityAddressBookKey=" + entityAddressBookKey + ", recordKeyVoucher=" + recordKeyVoucher + ", recordKeyMatchedPo=" + recordKeyMatchedPo + ", numberPaymentOrCheck=" + numberPaymentOrCheck + ", datePaymentOrCheck=" + datePaymentOrCheck + ", typeReconciliation=" + typeReconciliation + ", numberAssetIdentification=" + numberAssetIdentification + ", statusFixedAssetPosted=" + statusFixedAssetPosted + ", numberInvoice=" + numberInvoice + ", dateInvoice=" + dateInvoice + ", entityInputBy=" + entityInputBy + ", recordKeyPaymentId=" + recordKeyPaymentId + ", entityGlPostedBy=" + entityGlPostedBy + ", datePosted=" + datePosted + ", taxRateCode=" + taxRateCode + ", taxExplCode=" + taxExplCode + ", taxExplanationDescription=" + taxExplanationDescription + "]";
	}
