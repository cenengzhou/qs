...
/**
 * RptIvAcctBalanceSl generated by hbm2java
 */
@Entity
@IdClass(RptIvAcctBalanceSlId.class)
@Table(name = "RPT_IV_ACCT_BALANCE_SL")
public class RptIvAcctBalanceSl implements Serializable {
	...
	public RptIvAcctBalanceSl() {
	}

	public RptIvAcctBalanceSl(DimAccountMaster dimAccountMaster, BigDecimal fiscalYear, String accountPeriod,
	...
	public RptIvAcctBalanceSl(DimAccountMaster dimAccountMaster, BigDecimal fiscalYear, String accountPeriod,
			String accountSubLedger, String accountTypeSubLedger, String entityBusinessUnitKey, String accountObject,
			String accountSubsidiary, String accountDescription, String currencyLocal, BigDecimal aaAmountPeriod,
			BigDecimal jiAmountPeriod, BigDecimal aaAmountAccum, BigDecimal jiAmountAccum) {
		super();
		this.dimAccountMaster = dimAccountMaster;
		this.fiscalYear = fiscalYear;
		this.accountPeriod = accountPeriod;
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof RptIvAcctBalanceSl)) {
			return false;
		}
		RptIvAcctBalanceSl other = (RptIvAcctBalanceSl) obj;
	...
	public String toString() {
		return "RptIvAcctBalanceSl [dimAccountMaster=" + dimAccountMaster + ", fiscalYear=" + fiscalYear
