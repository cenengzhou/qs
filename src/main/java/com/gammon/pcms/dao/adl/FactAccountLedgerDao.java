...
@Repository
public class FactAccountLedgerDao extends BaseAdlHibernateDao<FactAccountLedger> {

	public FactAccountLedgerDao() {
		super(FactAccountLedger.class);
	}

	@SuppressWarnings("unchecked")
	public Collection<? extends FactAccountLedger> obtainFactAccountLedger(String account_type_ledger, String entity_doc_company_key, BigDecimal number_document, String number_je_line_extension, BigDecimal number_journal_entry_line, String type_document) throws DatabaseOperationException{
		...
		List<FactAccountLedger> factAccountLedgerList = criteria.list();
