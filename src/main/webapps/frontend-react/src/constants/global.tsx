...
export const SUBCONTRACTRETENTIONTERMS = {
...
export const GLOBALPARAMETER = {
  ...
  getIdPlusValue: function (arr: { [key: string]: object }[]) {
  ...
  getAttributeArray: function (
    objArray: { [key: string]: { [key: string]: object } }[],
    attribute: string
  ) {
  ...
  changeKeyValue: function (
    arr: { [key: string]: object }[],
    oldKey: string,
    oldValue: string,
    newKey: string,
    newValue: string
  ) {
    const newArr: { [key: string]: object }[] = []
    arr.forEach(function (obj) {
  ...
  approvalType: [
    {
      id: 'SP',
      value: 'Interim Payment',
      details: 'For interim payment of awarded subcontract'
    },
    {
      id: 'SF',
      value: 'Final Account',
      details: 'For final account of awarded subcontract'
    },
    {
      id: 'NP',
      value: 'Payment Requisition for subcontract not yet awarded',
      details: 'For non-awarded subcontract'
    },
    {
      id: 'EP',
      value: 'Early Release of Payment',
      details:
        'Bypass Payment Terms - Pay when Paid to release payment to Subcontractor. Approval of Executive Director is required.'
    },
    {
      id: 'SM',
      value: 'Variation to SC Award (Cumulative amount)',
      details: 'For addendum'
    },
    {
      id: 'SL',
      value: 'SC Addendum (> 25% of Original SC Sum or HKD$250,000)',
      details:
        'For addendum with amount >25% of Original SC Sum or >HKD$250,000'
    },
    { id: 'VA', value: 'Split Subcontract', details: 'For split subcontract' },
    {
      id: 'VB',
      value: 'Terminate Subcontract',
      details: 'For interim payment of awarded subcontract'
    },
    {
      id: 'FR',
      value: 'Under Finance Review',
      details: "For finance review with Payment Term 'QS0'"
    },
    { id: 'AW', value: 'SC Award', details: 'For awarded subcontract' },
    {
      id: 'ST',
      value: 'SC Award over budget (Over-budget amount)',
      details: 'For awarded subcontract with over-budget amount'
    },
    {
      id: 'V5',
      value: 'Varied SC Award',
      details:
        'For awarded subcontract with non-standard term payment OR tender variance exists OR request for approval to change the manner of execution of subcontract from main contract OR tenderer list < 3'
    },
    {
      id: 'V6',
      value: 'Varied SC Award and over-budget',
      details: 'V5 and over-budget amount'
    },
    {
      id: 'RM',
      value: 'Negative Main Contract Certificate',
      details:
        'For Main Contract Certificate with negative net certificate amount'
    }
  ],
  mainContractCertificateStatus: [
    ...
    { id: '200', value: 'Certificate(IPC) Waiting for special approval' },
    {
      id: '300',
      value:
        "Certificate(IPC) Posted to Finance's Account Receivable(AR) Ledger"
    },
    {
      id: '400',
      value:
        "Certified Amount Received Status '400' was used for historical Main Contract Certificates which were created in JDE QS System."
    }
  ],
  subcontractStatus: [
  ...
  paymentInformation: [
    {
      id: 'Interim Payment Schedule (Subcontract)',
      value: 'Interim Payment Schedule (Subcontract)'
    },
    {
      id: 'Interim Payment Schedule (Main Contract)',
      value: 'Interim Payment Schedule (Main Contract)'
    }
  ],
  subcontractorNature: [
    { id: 'DSC', value: 'DSC' },
  ...
  subcontractorFinancialAlertStatus: function (status: string) {
  ...
  forecast: {
    ...
    Others: 'Others',
    TotalContingency: 'Total Contingency',
    Risks: 'Risks',
    Opps: 'Opps',
...
export const GLOBALMESSAGE = {
  ...
  deleteAttachment: 'Are you sure to delete attachments',
  maxCharLimitReached: "You've reached the max. limit of text length!",
