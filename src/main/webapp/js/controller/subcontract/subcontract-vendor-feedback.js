mainApp.controller("SubcontractVendorFeedbackModalCtrl", ['$scope', '$uibModalInstance', 'uiGridConstants', 'modalParam', '$cookies', 'tenderService', '$state', 'modalService', 'roundUtil', 'paymentService', 'confirmService', 'subcontractService', 
	...
	$scope.gridOptions = {
			...
			columnDefs: [
			             ...
			             { field: "quantity" , enableCellEdit: false, width:110 , cellClass: 'text-right', cellFilter: 'number:4'},
			             { field: "rateBudget" , displayName:"Budget Rate", enableCellEdit: false, width:110, cellClass: 'text-right', cellFilter: 'number:4'},
			             { field: "amountBudget" ,displayName:"Budget Amount", enableCellEdit: false, width:110,  cellClass: 'text-right', cellFilter: 'number:2',},
			             { field: "rateSubcontract" , displayName:"SC Rate", enableCellEdit: true, width:110 , cellClass: 'text-right blue', cellFilter: 'number:4'},
			             { field: "amountSubcontract" ,displayName:"SC Amount", enableCellEdit: true, width:110 , cellClass: 'text-right blue', cellFilter: 'number:2',
			            	 aggregationType: uiGridConstants.aggregationTypes.sum,
			            	 footerCellTemplate: '<div class="ui-grid-cell-contents" style="text-align:right;"  >{{col.getAggregationValue() | number:2 }}</div>'},
		            	 { field: "amountForeign", enableCellEdit: false, width:110 , cellClass: 'text-right', cellFilter: 'number:2',
		            		 aggregationType: uiGridConstants.aggregationTypes.sum,
		            		 footerCellTemplate: '<div class="ui-grid-cell-contents" style="text-align:right;"  >{{col.getAggregationValue() | number:2 }}</div>'},
