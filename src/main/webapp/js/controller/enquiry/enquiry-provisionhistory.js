...
mainApp.controller('EnquiryProvisionHistoryCtrl', ['$scope' , '$rootScope', '$http', 'modalService', 'blockUI', 'SessionHelper', 
	...
	$scope.blockEnquiryProvisionHistory.start('Under Construction');
