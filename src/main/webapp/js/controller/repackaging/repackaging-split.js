mainApp.controller("RepackagingSplitModalCtrl", ['$scope', '$http', '$location', '$uibModalInstance', 'uiGridConstants', function ($scope, $http, $location, $uibModalInstance, uiGridConstants) {
