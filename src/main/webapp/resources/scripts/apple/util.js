var registerOnloadNumber=0;
var registerOnloadFunctions=new Array();

function registerOnloadFunction(funcName){
//alert('funcName: '+funcName);
    registerOnloadFunctions[registerOnloadNumber] = funcName;
    registerOnloadNumber++;
}

function initOnloadFunctions(){
    for(var i=0; i<registerOnloadNumber; i++){
        //alert(uaFunc[i]+"()");
        eval(registerOnloadFunctions[i]+"()");
    }
}
